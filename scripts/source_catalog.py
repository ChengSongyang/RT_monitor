...
SOURCE_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        'domain_patterns': ['aacrjournals.org/cancerdiscovery'],
        'aliases': ['Cancer Discovery'],
        'collection_method': 'AACR 期刊 RSS 订阅',
        'trust_level': 'high',
        'description': 'AACR 旗下高质量肿瘤研究期刊。',
        'enabled': True,
    },
    {
        ...
        'domain_patterns': ['aacrjournals.org/clincancerres'],
        'aliases': ['Clinical Cancer Research'],
        'collection_method': 'AACR 期刊 RSS 订阅',
        'trust_level': 'high',
        'description': 'AACR 旗下临床转化肿瘤研究期刊。',
        'enabled': True,
    },
    {
        'id': 'astro',
    ...
    },
    {
        'id': 'medlineplus',
        'name': 'MedlinePlus',
        'short_name': 'MedlinePlus',
        'kind': 'medical_reference',
        'source_type': 'news',
        'homepage': 'https://medlineplus.gov/',
        'domain_patterns': ['medlineplus.gov'],
        'aliases': ['MedlinePlus Cancer', 'MedlinePlus Radiation Therapy'],
        'collection_method': 'MedlinePlus 主题 RSS 订阅',
        'trust_level': 'high',
        'description': 'NIH 面向公众的医学参考与患者教育信息来源。',
        'enabled': True,
    },
    {
        'id': 'clinicaltrials',
